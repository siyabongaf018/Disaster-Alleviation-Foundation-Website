...
Database name = DisasterEllevationFoundation
Connection String = Data Source=(LocalDB)\MSSQLLocalDB;Initial Catalog=DisasterEllevationFoundation;Integrated Security=True*/
...
AvailableNumberOfItems INT not null,
DonationDate datetime not null,
